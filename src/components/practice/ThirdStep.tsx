...
const ThirdStep = () => {
    ...
    const handleAnswerOptionClick = (ansop) =>{
        ...
        if (ansop.questionWord === answer){
            ...
            setLearnedWords([...learnedWords, [ansop.questionWord, <span className='text-green-400'>+1%</span>]])
            if (answer !== ''){
    ...
    return (
        <div className='flex mt-20 justify-between'>
            {quiz.length > 0 ? <div className="block p-6 border bg-white border-gray-200 rounded-lg shadow w-2/4 max-md:w-full m-auto dark:bg-navbar">
